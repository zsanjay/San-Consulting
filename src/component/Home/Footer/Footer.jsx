        ...
        <section className='row footer'>
            <Row className="col-md-11 mx-auto">
                ...
                <Col md={6} lg={3} className="fAboutUs">
                    ...
                    <p className="aboutUsDes">At San Consulting, we are dedicated to providing expert consulting services that drive growth, innovation, and efficiency for businesses across various industries. With a team of experienced professionals, we specialize in delivering strategic insights, data-driven solutions, and customized approaches to meet your unique business needs.</p>
            ...
            <p className="copyRight">Copyright &copy; 2024 <span className="fHighlight">Sanjay Mehta</span>. All rights reserved.</p>
        </section>
    );
};
